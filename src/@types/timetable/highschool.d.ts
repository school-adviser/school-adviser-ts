/**
 * @description 중학교 시간표 정보를 담는 인터페이스
 * @interface
 ...
 */
export interface HighSchoolTimetableType {
    /**
     * @description 시도교육청코드
     * @type {string}
     *
 ...
 * @property {string} dayNightCourse 주야과정명
 * @property {string} realm 계열명
 * @property {string} department 학과명
 * @property {string} grade 학년
 * @property {string} classroom 강의실명
 ...
 */
export interface HighSchoolTimetableParams {
    /**
     * @description 학년도
     * @type {string}
     *
     ...
     * '주간'
     */
    dayNightCourse?: string | undefined;
